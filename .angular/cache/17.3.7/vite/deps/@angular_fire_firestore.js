...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  setDatabaseDeletedListener(e) {
    this.Ei.L((t) => __async(this, null, function* () {
...
var __PRIVATE_PersistentStream = class {
  ...
  e_() {
    this.state = 5, this.Yo.$o(() => __async(this, null, function* () {
          ...
          function __PRIVATE_handleTargetError(e2, t2) {
            return __async(this, null, function* () {
              ...
              for (const r of t2.targetIds)
                e2.F_.has(r) && (yield e2.remoteSyncer.rejectListen(r, n2), e2.F_.delete(r), e2.L_.removeTarget(r));
            });
          }(e, t)
        );
      } catch (n2) {
    ...
    (yield function __PRIVATE_handleWriteError(e2, t2) {
      return __async(this, null, function* () {
        if (function __PRIVATE_isPermanentWriteError(e3) {
          ...
          const n = e2.v_.shift();
          __PRIVATE_ensureWriteStream(e2).t_(), yield __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  return __async(this, null, function* () {
    e.Ba = (t2, n2, r2) => function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
      return __async(this, null, function* () {
...
function __PRIVATE_syncEngineUnlisten(e, t, n) {
  return __async(this, null, function* () {
    ...
    if (r.isPrimaryClient) {
      ...
      __PRIVATE_removeAndCleanupTarget(r, i.targetId), yield __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        i.targetId,
        /*keepPersistedTargetData=*/
        true
...
function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  return __async(this, null, function* () {
    ...
    }), yield Promise.all(o), r.Sa.h_(i), yield function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
      return __async(this, null, function* () {
  ...
  return __async(this, null, function* () {
    ...
    for (const e2 of t) {
      ...
      if (n2 && 0 !== n2.length) {
        ...
        for (const e3 of n2) {
          const t3 = r.ba.get(e3), n3 = yield __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
    ...
    return __async(this, null, function* () {
      ...
      const t = yield function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
        return __async(this, null, function* () {
          ...
          }, i = yield n.xo("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
          i.forEach((e3) => {
    ...
    return __async(this, null, function* () {
      ...
      e.forEach((e2, t) => {
        ...
        return __async(this, null, function* () {
          ...
          yield n.Co("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
        });
...
var __PRIVATE_TransactionRunner = class {
  ...
  eu() {
    this.Yo.$o(() => __async(this, null, function* () {
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  Tu() {
    return __async(this, null, function* () {
      if (0 !== this.su.length) {
        try {
          yield this.su[0](), this.su.shift(), this.Yo.reset();
        } catch (e) {
          if (!__PRIVATE_isIndexedDbTransactionError(e))
            throw e;
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S, "4.6.2", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(S, "4.6.2", "esm2017");
}();
